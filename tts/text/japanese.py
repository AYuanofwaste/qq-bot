...
tokenizer = AutoTokenizer.from_pretrained(os.path.join(_current_file_path, "..", "bert", "deberta-v2-large-japanese-char-wwm"), local_files_only=True)
...
if __name__ == "__main__":
    tokenizer = AutoTokenizer.from_pretrained(os.path.join(_current_file_path, "..", "bert", "deberta-v2-large-japanese"))
