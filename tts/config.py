...
class Config:
    def __init__(self, config_path: str):
        ...
        with open(file=config_path, mode="r", encoding="utf-8") as file:
            ...
            # 环境变量可覆盖 translate 配置
            env_app_key = os.environ.get("BAIDU_APP_ID")
            env_secret_key = os.environ.get("BAIDU_SECRET_KEY")
            if env_app_key:
                self.translate_config.app_key = env_app_key
            if env_secret_key:
                self.translate_config.secret_key = env_secret_key
